...
class EmailListener(
  ...
  fun receiveEmailNotification(message: SqsMessage) {
    try {
      ...
      val errorList = mutableListOf<CrimeBatchEmailAttachmentIngestionError>()
      ...
      crimeBatchEmailAttachment.crimeBatchEmailAttachmentIngestionErrors.addAll(errorList)
